        ...
        <ul class="navbar-nav mr-auto">
            ...
            <c:if test="${pageContext.request.isUserInRole('UserEditor')}">
                ...
                <li class="nav-item ${activePage eq 'Candidates' ? ' active' : ''}">
                    <a class="nav-link" href="${pageContext.request.contextPath}/Candidates">Candidate</a>
                </li>
                </c:if>
                
                <c:if test="${pageContext.request.isUserInRole('UserEditor')}">
                <li class="nav-item ${activePage eq 'Positions' ? ' active' : ''}">
                    <a class="nav-link" href="${pageContext.request.contextPath}/Positions">Position</a>
                </li>
                </c:if>
        </ul>
